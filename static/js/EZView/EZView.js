layui.use(['jquery'], function() {
    ...
    $.fn.EZView = function () {
        ...
        self.builtObjectTemplate = function(index){
            ...
            // To show pdf files
            if (!arIndex[index].isImg) {
                content = '<iframe class="EZView-iframe" frameborder="0" index-render="'+index+'" ' +
        ...
        return $(this).each(function(i, el){
            ...
            arIndex[i].isImg    = $.isEmptyObject($el.attr('href'));
